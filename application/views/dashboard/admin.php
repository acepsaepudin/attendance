...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('dashboard/edit/'.$row->username);?>"><i class="glyphicon glyphicon-edit"></i></a></td>
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                ...
                success:function(html){
                    location.href="<?php echo site_url('dashboard/admin/delete_success');?>";
                }
            });
        });
    });
